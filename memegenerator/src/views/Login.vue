    ...
    <div class="row">
      <div class="form-login col-12">
        <div class="form-group">
          <label for="exampleInputEmail1" class="d-block text-left"
            >Email</label
          >
          <input
            v-model="email"
        ...
        <div class="form-group">
          <label for="exampleInputPassword1" class="d-block text-left"
            >Mật khẩu</label
          >
          <input
            v-model="password"
...
export default {
  ...
  methods: {
    ...
    handleEnterEmail() {
      this.password
        ? this.handleLogin()
        : this.$refs.passwordIp
        ? this.$refs.passwordIp.focus()
        : (() => {})();
    },
    validLoginForm() {
      // Promise
